...
const pokemon = ["charmander", "bulbasauro", "squirtle"]
console.log(pokemon.length)

//includes

const seriesBoas = ["BreakingBed", "rick morty", "strangerSthings"]
seriesBoas.includes("BreakingBedd") //true
seriesBoas.includes("vandinha") //false
